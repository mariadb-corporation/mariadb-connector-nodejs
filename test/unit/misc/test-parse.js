...
describe("parse", () => {
  describe("batch rewrite", () => {
    ...
    it("rewritable with constant parameters ", () => {
      const res = Parse.splitRewritableQuery("INSERT INTO TABLE(col1,col2,col3,col4, col5) VALUES (9, ?, 5, ?, 8) ON DUPLICATE KEY UPDATE col2=col2+10");
      assert.deepEqual(res, {
        "multipleQueries": true,
        "partList": [
    ...
    it("test comments ", () => {
      const res = Parse.splitRewritableQuery("/* insert Select INSERT INTO tt VALUES (?,?,?,?)  */"
      + " INSERT into "
    ...
    it("rewritable with constant parameters and parameters after ", () => {
      const res = Parse.splitRewritableQuery("INSERT INTO TABLE(col1,col2,col3,col4, col5) VALUES (9, ?, 5, ?, 8) ON DUPLICATE KEY UPDATE col2=?");
      assert.deepEqual(res, {
        "multipleQueries": true,
        "partList": [
          "INSERT INTO TABLE(col1,col2,col3,col4, col5) VALUES",
    ...
    it("insert select", () => {
      const res = Parse.splitRewritableQuery("insert into test_insert_select ( field1) (select  TMP.field1 from "
    ...
    it("semicolon", () => {
      const res = Parse.splitRewritableQuery("INSERT INTO tt (tt) VALUES (?); INSERT INTO tt (tt) VALUES ('multiple')");
      assert.deepEqual(res, {
        "multipleQueries": true,
        "partList": [
    ...
    it("line finished comment", () => {
      const res = Parse.splitRewritableQuery("INSERT INTO tt (tt, tt2) VALUES (LAST_INSERT_ID(), ?)");
      assert.deepEqual(res, {
        "multipleQueries": true,
        "partList": [
