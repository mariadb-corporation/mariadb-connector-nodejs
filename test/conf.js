...
if (process.env.TEST_PASSWORD)
  baseConfig['password'] = process.env.TEST_PASSWORD;
if (process.env.TEST_DB) baseConfig['database'] = process.env.TEST_DB;
if (process.env.TEST_PORT)
  baseConfig['port'] = parseInt(process.env.TEST_PORT, 10);
if (process.env.TEST_SOCKET_PATH)
  baseConfig['socketPath'] = process.env.TEST_SOCKET_PATH;
if (process.env.TEST_DEBUG_LEN)
  baseConfig['debugLen'] = process.env.TEST_DEBUG_LEN;
