...
class CachedPrepareResultPacket extends PrepareResultPacket {
  constructor(statementId, parameterCount, columns, database, sql, placeHolderIndex, conn, conOpts) {
    super(statementId, parameterCount, columns, database, sql, placeHolderIndex, conn, conOpts);
    this.cached = true;
    this.use = 1;
  }
