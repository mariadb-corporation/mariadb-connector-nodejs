...
class CachedPrepareResultPacket extends PrepareResultPacket {
  constructor(statementId, parameterLength, columns, database, sql, placeHolderIndex, conn, conOpts) {
    super(statementId, parameterLength, columns, database, sql, placeHolderIndex, conn, conOpts);
    this.cached = true;
    this.use = 1;
  }
