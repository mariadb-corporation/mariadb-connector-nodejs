...
class TextEncoder {
  /**
   * Escape an identifier, doubling any backtick it contains.
   *
   * Object keys expanded by permitSetMultiParamEntries become column names, so
   * a key holding a backtick would otherwise close the identifier and let the
   * rest of the key be parsed as SQL.
   *
          ...
          if (
            ...
            if (opts.permitSetMultiParamEntries) {
              ...
              for (let key in value) {
                ...
                out.writeString(TextEncoder.escapeId(key));
                out.writeStringAscii('=');
