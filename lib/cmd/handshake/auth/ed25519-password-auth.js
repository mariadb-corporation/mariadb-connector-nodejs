...
class Ed25519PasswordAuth extends PluginAuth {
  ...
  static encryptPassword(password, seed) {
    ...
    // Ed25519 signing per RFC 8032: SHA-512 of the password derives the private scalar
    // (clamped below). Protocol-mandated, not password-at-rest storage, so a slow KDF
    // (bcrypt/scrypt/argon2) does not apply.
