...
class Parser extends Command {
  ...
  readResultSet(packet, info) {
    ...
    this._getValue = this.opts.typeCast
      ? this.readCastValue
      : (column, packet, index, nullBitmap, opts) => column.read(packet, index, nullBitmap, opts);
  ...
  readCastValue(column, packet, index, nullBitmap, opts) {
    this.decoderCastWrapper(column, packet, index, nullBitmap, opts);
    return opts.typeCast(column, column.read.bind(column, packet, index, nullBitmap, opts));
  }
