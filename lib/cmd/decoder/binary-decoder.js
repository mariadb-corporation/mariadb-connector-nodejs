...
export function castWrapper(column, packet, opts, nullBitmap, index) {
  ...
  column.string = () =>
    isNull ? null : isFixedWidth ? readFixedWidthAsString(column, packet) : packet.readStringLengthEncoded();
  column.buffer = () =>
    isNull
      ? null
      : isFixedWidth
  ...
  column.float = () =>
    isNull ? null : column.columnType === FieldType.DOUBLE ? packet.readDouble() : packet.readFloat();
  ...
  column.int = () => (isNull ? null : column.signed() ? packet.readInt32() : packet.readUInt32());
  column.long = () => (isNull ? null : column.signed() ? packet.readBigInt64() : packet.readBigUInt64());
