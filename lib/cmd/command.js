        ...
        while (subPacket.remaining()) {
          ...
          switch (type) {
            case StateChange.SESSION_TRACK_SYSTEM_VARIABLES:
              ...
              const variable = subSubPacket.readStringLengthEncoded(opts.collation.charset);
              const value = subSubPacket.readStringLengthEncoded(opts.collation.charset);
            ...
            case StateChange.SESSION_TRACK_SCHEMA:
              ...
              info.database = subSubPacket2.readStringLengthEncoded(opts.collation.charset);
              break;
          }
        }
      }
