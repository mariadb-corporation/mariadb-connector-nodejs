...
const shouldNamedBufferEncoding = typeof navigator !== 'undefined' && navigator?.userAgent?.includes('Cloudflare');
/**
 * @param {NonNullable<BufferEncoding>} encoding
 * @returns {BufferEncoding | undefined}
 */
module.exports.fasterBufferEncoding = (encoding) => {
  if (shouldNamedBufferEncoding) return encoding;
  else if (encoding === 'utf8' || encoding === 'utf-8') return void 0;
