...
class Connection extends EventEmitter {
   ...
   */
  authSucceedHandler() {
    // authentication succeeded: multi-part packet reassembly is now permitted (CONJS-358)
  ...
  createSecureContext(info, callback) {
    ...
    // permit self-signed certificates; server identity is verified separately.
