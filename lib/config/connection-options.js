...
class ConnectionOptions {
  constructor(opts) {
    ...
    // socket
    this.queryTimeout = isNaN(opts.queryTimeout) || opts.queryTimeout < 0 ? 0 : opts.queryTimeout;
    this.socketTimeout = isNaN(opts.socketTimeout) || opts.socketTimeout < 0 ? 0 : opts.socketTimeout;
