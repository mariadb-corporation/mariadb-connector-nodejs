...
class ConnectionOptions {
  constructor(opts) {
    ...
    this.maxAllowedColumns = opts.maxAllowedColumns === undefined ? 65535 : Number(opts.maxAllowedColumns);
    ...
    if (!Number.isInteger(this.maxAllowedColumns) || this.maxAllowedColumns < 1) {
      throw new RangeError(`maxAllowedColumns must be an integer greater than 0. was '${opts.maxAllowedColumns}'`);
    }
  }
